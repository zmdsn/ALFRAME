function [best_fvalue,best_solution,run_series,run_info,user_set] = DEctob1(func_name , algo_config,func_config,user_config)
        ...
        for mi = 1:PopuSize
            ...
            switch choice
                case 1
                    ...
                    Vswarm(:,mi) = swarm(:,mi) +F(mi)*(globalBestSolution-swarm(:,mi))+F(mi)*(swarm(:,rIn(1))-swarm(:,rIn(2)));
                otherwise
