function [best_fvalue,best_solution,run_series,run_info,user_set] = GADD(func_name , algo_config,func_config,user_config)
...
%     Altime = cputime - mytime;                  % 计算时间
%     display(['      GAD time = ' num2str(Altime)]);  % 显示时间
