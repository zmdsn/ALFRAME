...
void cec15_test_func(double *x, double *f, int nx, int mx,int func_num)
{
    ...
    if (ini_flag==0)
    {
        ...
        /* Load Matrix M*/
        sprintf(FileName, "functions/cec15_func/input_data/M_%d_D%d.txt", func_num,nx);
        fpt.open(FileName);
        if (!fpt.good())
        {
        ...
        if (func_num>=9)
        {
            sprintf(FileName, "functions/cec15_func/input_data/bias_%d.txt", func_num);
            fpt.open(FileName);
            if (!fpt.good())
            {
                mexErrMsgTxt("\n Error: Cannot open input file for reading \n");
        ...
        /* Load shift_data */
        sprintf(FileName, "functions/cec15_func/input_data/shift_data_%d.txt", func_num);
        fpt.open(FileName);
        if (!fpt.good())
        {
            mexErrMsgTxt("\n Error: Cannot open input file for reading \n");
        ...
        {
            sprintf(FileName, "functions/cec15_func/input_data/shuffle_data_%d_D%d.txt", func_num, nx);
            fpt.open(FileName);
            if (!fpt.good())
            {
                mexErrMsgTxt("\n Error: Cannot open input file for reading \n");
