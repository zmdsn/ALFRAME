function X2 = TCA_up_to_top( initial_point,DPoint,U,U_d,Q1,BasicParameter1 )
% TCA_down_to_root.m  用牛顿迭代法求解TCA方程，往齿顶计算
...
for fai1=fai1_st:-0.01:0
    ...
    for i=1:N
        ...
        if F_distance < tol
            ...
            X2(m2,:)=[ u_output,beta1_output,fai1_output,fai2_output];
            break;
        end
